                                ...
                                >
                                    ...
                                    <div className="p-8 flex flex-col flex-1 justify-between">
                                        ...
                                        <div className="flex items-center justify-between pt-6 border-t border-gray-50 mt-4">
                                            ...
                                            <button className="bg-[#5D4037] text-white px-6 py-3 rounded-2xl font-black text-sm hover:bg-red-500 shadow-lg transition-all active:scale-95 cursor-pointer flex items-center gap-2 group/btn">
                                                <span>Buy Now</span>
