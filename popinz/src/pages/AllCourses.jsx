                            ...
                            >
                                ...
                                <div className="h-64 overflow-hidden relative">
                                    ...
                                    <div className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm px-4 py-1.5 rounded-full shadow-md">
                                        <span className={`text-xs font-black uppercase tracking-widest ${course.category === 'Foundation' ? 'text-amber-500' : 'text-purple-600'}`}>
                                            {course.level}
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div className="p-8 flex flex-col flex-1">
                                    <div className="flex justify-between items-start mb-2">
                                        <p className="text-red-500 text-sm font-bold uppercase tracking-widest">{course.category} Course</p>
                                        <span className="text-xs font-bold text-gray-500 bg-gray-100 px-2 py-1 rounded-md">
                                            {course.duration}
                                        </span>
                                    </div>

                                    <h3 className="text-3xl font-black text-[#4E342E] mb-3 leading-tight">
                                        {course.title}
                                    </h3>
                                    ...
                                    <div className="mt-auto border-t border-gray-100 pt-6 space-y-5">
                                        ...
                                        <div className="flex items-center justify-between bg-amber-50/50 p-3 rounded-xl border border-amber-100">
                                            <div className="flex flex-col">
                                                ...
                                                <span className="text-xl font-black text-[#4E342E]">₹{course.pricing?.online || course.price}/-</span>
                                            </div>
                                        ...
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                ...
                                                className="w-full bg-[#4E342E]/5 text-[#4E342E] px-4 py-3 rounded-xl font-bold text-sm hover:bg-[#4E342E]/10 transition-colors active:scale-95 cursor-pointer border border-[#4E342E]/10 flex items-center justify-center gap-2"
                                            >
                                                View Content
                                            </button>
                                            <button
